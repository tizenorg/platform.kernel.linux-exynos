...
/**
 * smack_kdbus_conn_init - Set the security blob for a KDBus connection
 * @conn: the connection
 *
 * Returns 0
 */
static int smack_kdbus_conn_init(struct kdbus_conn *conn)
{
...
#ifdef CONFIG_KDBUS
	.kdbus_conn_init =		smack_kdbus_conn_init,
