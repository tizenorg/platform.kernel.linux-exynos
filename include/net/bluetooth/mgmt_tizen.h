...
#define MGMT_OP_SET_ADVERTISING_PARAMS		0x0040 //(TIZEN_OP_CODE_BASE + 0x01)
...
#define MGMT_OP_SET_ADVERTISING_DATA		0x0041 //(TIZEN_OP_CODE_BASE + 0x02)
...
#define MGMT_OP_SET_SCAN_RSP_DATA		0x0042 //(TIZEN_OP_CODE_BASE + 0x03)
...
#define MGMT_OP_ADD_DEV_WHITE_LIST		0x0043 //(TIZEN_OP_CODE_BASE + 0x04)
...
#define MGMT_OP_REMOVE_DEV_FROM_WHITE_LIST	0x0044 //(TIZEN_OP_CODE_BASE + 0x05)
...
#define MGMT_OP_CLEAR_DEV_WHITE_LIST		0x0045 //(TIZEN_OP_CODE_BASE + 0x06)
#define MGMT_OP_CLEAR_DEV_WHITE_LIST_SIZE	0

/* BEGIN TIZEN_Bluetooth :: RSSI monitoring   */
#define MGMT_OP_SET_RSSI_ENABLE			0x0046 // (TIZEN_OP_CODE_BASE + 0x07)
...
#define MGMT_OP_GET_RAW_RSSI			0x0047 //(TIZEN_OP_CODE_BASE + 0x08)
...
#define MGMT_OP_SET_RSSI_DISABLE		0x0048 //(TIZEN_OP_CODE_BASE + 0x09)
...
#define MGMT_OP_START_LE_DISCOVERY		0x0049 //(TIZEN_OP_CODE_BASE + 0x0a)
struct mgmt_cp_start_le_discovery {
	    __u8 type;
} __packed;
#define MGMT_START_LE_DISCOVERY_SIZE		1

#define MGMT_OP_STOP_LE_DISCOVERY		0x004A //(TIZEN_OP_CODE_BASE + 0x0b)
...
#define MGMT_OP_DISABLE_LE_AUTO_CONNECT		0x004B //(TIZEN_OP_CODE_BASE + 0x0c)
#define MGMT_DISABLE_LE_AUTO_CONNECT_SIZE	0
/* END TIZEN_Bluetooth */

#define MGMT_LE_CONN_UPDATE_SIZE		14
#define MGMT_OP_LE_CONN_UPDATE			0x004C //(TIZEN_OP_CODE_BASE + 0x0d)
...
#define MGMT_OP_SET_MANUFACTURER_DATA		0x004D //(TIZEN_OP_CODE_BASE + 0x0e)
struct mgmt_cp_set_manufacturer_data {
	__u8 data[28];
} __packed;
#define MGMT_SET_MANUFACTURER_DATA_SIZE		28

#define MGMT_OP_LE_SET_SCAN_PARAMS		0x004E //(TIZEN_OP_CODE_BASE + 0x0f)
...
#define MGMT_OP_SET_VOICE_SETTING		0x004F //(TIZEN_OP_CODE_BASE + 0x10)
...
#define MGMT_OP_GET_ADV_TX_POWER		0x0050 //(TIZEN_OP_CODE_BASE + 0x11)
#define MGMT_GET_ADV_TX_POWER_SIZE			0
struct mgmt_rp_get_adv_tx_power {
	__s8 adv_tx_power;
} __packed;

#define MGMT_OP_ENABLE_6LOWPAN		0x0051 //(TIZEN_OP_CODE_BASE + 0x12)
#define MGMT_ENABLE_BT_6LOWPAN_SIZE			1
struct mgmt_cp_enable_6lowpan {
	__u8 enable_6lowpan;
} __packed;

#define MGMT_OP_CONNECT_6LOWPAN	0x0052 //(TIZEN_OP_CODE_BASE + 0x13)
struct mgmt_cp_connect_6lowpan {
	struct mgmt_addr_info addr;
} __packed;
#define MGMT_CONNECT_6LOWPAN_SIZE	7

#define MGMT_OP_DISCONNECT_6LOWPAN	0x0053 //(TIZEN_OP_CODE_BASE + 0x14)
