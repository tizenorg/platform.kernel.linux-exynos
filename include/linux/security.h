 ...
 *	Endpoint create
 * @kdbus_conn_init:
 *	Initialize connection (set security blob in the kdbus_conn structure)
 * @kdbus_conn_free:
...
struct security_operations {
	...
	int (*kdbus_conn_init)(struct kdbus_conn *conn);
...
static inline int security_kdbus_conn_init(struct kdbus_conn *conn)
{
	return 0;
}
